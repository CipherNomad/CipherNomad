...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=26&duration=2600&pause=800&color=3BA3FF&center=true&vCenter=true&width=900&lines=Hi,+I'm+Rahul+Raj+Singh+(@CipherNomad);Full+Stack+Developer+(MERN+%2B+Java);AI+%26+ML+%2F+GenAI+Explorer;Building+Modern+%26+Scalable+Applications" />
...
I’m a **Full Stack Developer (MERN + Java)** focused on building clean, scalable and user-centric web applications.  
My development journey is strongly rooted in **Java problem-solving**, backend systems, and modern web engineering.

Along with full-stack development, I actively explore **AI, Machine Learning, and Generative AI** to integrate intelligent features into real-world applications.

🔭 **Current focus:** MERN projects, Java backends, AI/ML fundamentals, GenAI-powered applications  
👯 **Collaborations:** MERN, Java, AI/ML, GenAI  
💬 **Ask me about:** MERN Stack, Java, API architecture, AI/ML , System design  
⚡ **Fun fact:** I debug like a detective and my mind auto-saves every code snippet.
...
AI-powered property recommendation platform with dynamic listings.

### 👗 **[Trendify – E-Commerce (MERN)](https://ciphernomad.github.io/Full-Stack-E-Commerce-Platform/)**  
Full fashion e-commerce site with cart, filtering and authentication.

### 🔢 **[CalcPro – Smart Calculator](https://ciphernomad.github.io/Calculator/)**  
Fast and responsive web calculator with keyboard support.
...
ML model that detects spam vs ham SMS.

### 📉 **[Customer Churn Prediction](https://www.rahulrajsingh.com/projects/churn-prediction)**  
Predicts customer churn using ML.

### 📊 **[Death Age Analysis](https://www.rahulrajsingh.com/projects/death-age-analysis)**  
Statistical analysis of lifespan patterns.
